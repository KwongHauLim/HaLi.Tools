...
{
    private readonly SSC.SHA1 _hash = SSC.SHA1.Create();
    protected override HashAlgorithm Algorithm => _hash;
}

public sealed class SHA256 : HashManaged
{
    private readonly SSC.SHA256 _hash = SSC.SHA256.Create();
    protected override HashAlgorithm Algorithm => _hash;
}

public sealed class SHA384 : HashManaged
{
    private readonly SSC.SHA384 _hash = SSC.SHA384.Create();
    protected override HashAlgorithm Algorithm => _hash;
}

public sealed class SHA512 : HashManaged
{
    private readonly SSC.SHA512 _hash = SSC.SHA512.Create();
    protected override HashAlgorithm Algorithm => _hash;
}